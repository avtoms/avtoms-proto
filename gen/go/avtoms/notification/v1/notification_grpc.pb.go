...
const (
	...
	NotificationService_SendReceipt_FullMethodName          = "/avtoms.notification.v1.NotificationService/SendReceipt"
...
type NotificationServiceClient interface {
	...
	SendReceipt(ctx context.Context, in *SendReceiptRequest, opts ...grpc.CallOption) (*SendResponse, error)
...
func (c *notificationServiceClient) SendReceipt(ctx context.Context, in *SendReceiptRequest, opts ...grpc.CallOption) (*SendResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SendResponse)
	err := c.cc.Invoke(ctx, NotificationService_SendReceipt_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NotificationServiceServer interface {
	...
	// SendReceipt delivers a finished receipt to a customer as a Telegram document.
	// Telegram fetches document_url itself, so the caller passes a link rather than bytes.
	SendReceipt(context.Context, *SendReceiptRequest) (*SendResponse, error)
	// Notify picks the best channel (Telegram, falling back to SMS).
...
func (UnimplementedNotificationServiceServer) SendReceipt(context.Context, *SendReceiptRequest) (*SendResponse, error) {
...
func _NotificationService_SendReceipt_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendReceiptRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NotificationServiceServer).SendReceipt(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NotificationService_SendReceipt_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotificationServiceServer).SendReceipt(ctx, req.(*SendReceiptRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var NotificationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _NotificationService_SendReceipt_Handler,
		},
		{
			MethodName: "Notify",
